...
/**
 * 
 * Constructor de la clase restauranteIsrael
 * 
...
/* 
 * Método por el que se conoce el número máximo de comensales en función del número de patatas en stock
 * 
...
/**
 * Método por el que se añade la cantidad de calamares recibidos en 1 pedido
 * 
 * @param c Cantidad de calamares añadidas al stock
 */
	public void addCalamares(int c) {
		this.c = this.c + c;
	}
/**
 * Método por el que se añade la cantidad de patatas recibidos en 1 pedido
 * 
 * @param d Cantidad de patatas añadidas al stock
 */
